...
const int right_X = A3; // define the right X pin to A2
...
void loop() 
{
  myservo1.attach(A2);  //set the control pin of Servo1 to A1
  myservo2.attach(9);  //set the control pin of Servo2 to A0
  myservo3.attach(8);   //set the control pin of Servo3 to D8
  myservo4.attach(A1);   //set the control pin of Servo4 to D9
